...
# -*- coding: utf-8 -*-
#
# python plot_par_fit_vsorg_grain.py ../caribu_out/June_15_2013/smallangle_whorl/1200_eabs ../caribu_out/June_15_2013/smallangle_whorl/1200_plant_positions ../caribu_out/June_15_2013/largeangle_whorl/1200_eabs ../caribu_out/June_15_2013/largeangle_whorl/1200_plant_positions


# python plot_par_fit_vsorg_grain.py ../caribu_out/June_15_2013/smallangle_nowhorl/1200_eabs ../caribu_out/June_15_2013/smallangle_nowhorl/1200_plant_positions ../caribu_out/June_15_2013/largeangle_nowhorl/1200_eabs ../caribu_out/June_15_2013/largeangle_nowhorl/1200_plant_positions
...
##### plot the curve_fit
plot(light_func((np.linspace(0.0, max(li_2X_percent)*2, 200), np.array(max(li_2X_percent))), k_2, partop_2), np.linspace(0., max(li_2X_percent)*2, 200), color=large_color,label='k = %f' %(k_2))

plot(light_func((np.linspace(0.0, max(li_1X_percent)*2, 200), np.array(max(li_1X_percent))), k_1, partop_1), np.linspace(0., max(li_1X_percent)*2, 200), color=small_color,label='k = %f' %(k_1))
...
plt.savefig("vsorg_grain_whorl_1200.png", dpi=300, format="png")
