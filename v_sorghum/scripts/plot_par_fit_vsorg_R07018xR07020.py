...
# -*- coding: utf-8 -*-
#
# python plot_par_fit_vsorg_R07018xR07020.py ../caribu_out/July_22_2014/R07018xR07020_63/1530_20_eabs ../caribu_out/July_22_2014/R07018xR07020_63/1530_20_plant_positions ../caribu_out/July_22_2014/R07018xR07020_73/1530_20_eabs ../caribu_out/July_22_2014/R07018xR07020_73/1530_20_plant_positions
...
axL = subplot(1,1,1)
##### plot the curve_fit
plot(light_func((np.linspace(0.0, max(li_2X_percent)*2, 200), np.array(max(li_2X_percent))), k_2, partop_2), np.linspace(0., max(li_2X_percent)*2, 200), color=large_color,label=r'$k$ = %f' %(k_2))
plot(light_func((np.linspace(0.0, max(li_1X_percent)*2, 200), np.array(max(li_1X_percent))), k_1, partop_1), np.linspace(0., max(li_1X_percent)*2, 200), color=small_color,label=r'$k$ = %f' %(k_1))

xlim(-15.0, 2300)
ylim(-1.0, 104.0)
legend(numpoints=1, bbox_to_anchor=(1, 0), loc=4, borderaxespad=0.)
xlabel('PAR ' r'($\mu$mol $m^{-2} s^{-1}$)')
ylabel('% depth')

savefig("vsorg_R07018xR07020.png", dpi=300, format="png")
